      ...
      <main className="w-full max-w-4xl mx-auto my-12 grid grid-cols-1 md:grid-cols-12 gap-8 items-center z-10">
        ...
        <div className="md:col-span-7 space-y-6 text-left">
          ...
          <div className="border-4 border-black bg-black/80 p-6 shadow-[8px_8px_0px_0px_#00ffff]">
            <h2 className="text-xl font-black text-[#ff007f] uppercase mb-2">
              💥 WHY CHOOSE BORING?
            </h2>
            <p className="text-sm md:text-base text-slate-300 leading-relaxed">
              Stop hanging out in dull corporate chat boxes.{" "}
              <strong className="text-white">Textup</strong> is the loud,
              unapologetic playground where rooms are born in milliseconds. Toss
              in a temporary room code, blast your messages, and disappear like
              dust.
            </p>
          </div>

          <div className="flex flex-wrap gap-2 text-xs font-black uppercase">
            <span className="bg-[#00ffff] text-black px-3 py-1 border-2 border-black">
              #WEBRTC
            </span>
            <span className="bg-[#ff007f] text-white px-3 py-1 border-2 border-black">
              #P2P
            </span>
            <span className="bg-[#39ff14] text-black px-3 py-1 border-2 border-black">
              #CHAOS
            </span>
          </div>
        </div>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <button
                ...
                className="w-full py-3 px-4 bg-[#ff007f] hover:bg-[#e00070] text-white font-black text-base border-4 border-black shadow-[4px_4px_0px_0px_#000] transition-all hover:translate-x-0.5 hover:translate-y-0.5 uppercase tracking-wider active:translate-x-1 active:translate-y-1 active:shadow-none"
              >
                ⚡ Create A Room
              </button>
              ...
              {Code && (
                <div className="bg-[#00ffff] border-4 border-black p-3.5 shadow-[4px_4px_0px_0px_#000] -rotate-1">
            ...
            <div className="relative flex py-1 items-center">
              ...
              <span className="shrink mx-4 font-black text-lg uppercase tracking-widest bg-black text-[#fcf800] px-3 py-1 border-2 border-black">
                OR
              </span>
              <div className="grow border-t-4 border-black"></div>
            </div>
